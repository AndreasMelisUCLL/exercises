...
def test_creation(sut: TaskList):
    # Assert
    assert 0 == len(sut)
...
def test_adding_task_with_due_day_in_future(sut: TaskList, tomorrow):
    # Arrange
...
def test_adding_task_with_due_day_in_past(sut: TaskList, yesterday):
    # Arrange
...
def test_task_becomes_finished(sut: TaskList, tomorrow):
    # Arrange
...
def test_task_becomes_overdue(sut: TaskList, calendar: CalendarStub, today, tomorrow):
    # Arrange
